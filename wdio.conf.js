...
const fs = require('fs');
const rmdir = require('./src/util/rmdir');
...
let mochaTimeout = process.env.DEBUG ? 99999999 : 60000;
...
exports.config = {
    ...
    baseUrl: 'https://projects.invisionapp.com',
    //
    ...
    reporters: ['allure','mochawesome','spec'],
